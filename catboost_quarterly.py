...
import os
import sys
from CatBoostParametersGridValidator import CatBoostParametersGridValidator
...
logfile_name = "catboost_quarterly.log"
run_id = '1'
...
for index,row in data_subset.iterrows():
    ...
    search = CatBoostParametersGridValidator(
        params,
        vals, 
        None, 
