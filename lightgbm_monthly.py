...
# Model spec template 
model_spec_template ="lightgbm_model_numleaves_%d_maxdepth_%d_learningrate_%d_nestimators_%d"
...
for index,row in yearly_data.iterrows():
    ...
    try:
        ...
        model_spec = model_spec_template%(gbmparams["num_leaves"], gbmparams["max_depth"], gbmparams["learning_rate"], gbmparams["n_estimators"])
